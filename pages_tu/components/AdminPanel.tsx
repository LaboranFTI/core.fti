                ...
                <div className="flex flex-col gap-6 mb-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2.5">
                      {letterLayoutSections.filter(s => ['activeStudent', 'observation', 'counseling', 'suRek'].includes(s.key)).map((section) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 border ${
                              isSelected
                                ? 'bg-blue-50 border-blue-300 text-blue-700 shadow-sm dark:bg-blue-900/30 dark:border-blue-700/50 dark:text-blue-300'
                                : 'bg-white border-slate-200 text-slate-600 hover:border-slate-300 hover:bg-slate-50 shadow-sm dark:bg-slate-800 dark:border-slate-700 dark:text-slate-400 dark:hover:border-slate-600 dark:hover:bg-slate-800/80'
                            }`}
                          >
                            {section.title}
                          </button>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2.5">
                      {letterLayoutSections.filter(s => ['research', 'interview', 'permission'].includes(s.key)).map((section) => {
                        const isSelected = selectedLayoutConfigKey === section.key;
                        return (
                          <button
                            key={section.key}
